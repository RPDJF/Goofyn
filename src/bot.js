...
if (!fs.existsSync(".env")) {
  logger.warn(
    "No .env file found. Please check the README.md for instructions on setting up the environment variables.",
  );
}
...
client.on(Events.InteractionCreate, async (interaction) => {
  ...
  try {
    ...
    const error_msg = {
      embeds: [
        errorMsg(dictionary.errors.title, dictionary.errors.execution_error),
      ],
      ephemeral: true,
    };
    try {
