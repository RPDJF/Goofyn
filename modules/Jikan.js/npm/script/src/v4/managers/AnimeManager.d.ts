 ...
 */
export declare enum AnimeForumFilter {
    All = "all",
    Episode = "episode",
    Other = "other"
}
 ...
 */
export interface AnimeSearchParameters extends baseManager.BaseSearchParameters {
    /**
 ...
 */
export declare class AnimeManager extends baseManager.BaseManager {
     ...
     * @throws Error if status is not between 200 and 300
     */
    getAnimeForum(animeId: number, params?: AnimeForumSearchParameters): Promise<baseModel.Forum[]>;
    /**
     ...
     * @throws Error if status is not between 200 and 300
     */
    getAnimeUserUpdates(animeId: number, params?: baseManager.PageSearchParameter): Promise<animeModel.AnimeUserUpdate[]>;
    /**
