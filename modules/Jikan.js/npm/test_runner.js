...
const filePaths = [
    "test/v4/core/CacheManager.test.js",
    "test/v4/core/RequestManager.test.js",
    "test/v4/managers/AnimeManager.test.js",
    "test/v4/managers/CharacterManager.test.js",
    "test/v4/managers/MangaManager.test.js",
    "test/v4/managers/RandomManager.test.js",
];
async function main() {
    const testContext = {
        process,
