...
function getGeminiContext({ interaction, message }) {
  return ([
    ...
    `I am ${
      ...
      interaction ? interaction.client.user.id : message.client.user.id
    }>, a murder drone`,
    `I was made by Banatawa, his id is <@773985750873800755>`,
    `I am friendly and goofy like "Serial Designation N" from "Murder Drones"`,
    `The message I will read will be in "${
      interaction ? interaction.channel.name : message.channel.name
